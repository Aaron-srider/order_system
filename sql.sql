...
INSERT INTO `college` VALUES (1,'计算机学院'),(2,'理学院');
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1437206767489634314 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `message` VALUES (1437206767489634309,3,1,1,'2021-09-13 08:20:15',NULL,1,'你好','我想申请工单，麻溜的','leetcode2.png',0,0),(1437206767489634310,3,1,1,'2021-09-13 18:56:14',NULL,1,'你好','我想申请工单，麻溜的','leetcode1.png',0,0),(1437206767489634311,3,1,1,'2021-09-15 20:24:58',NULL,0,'hello','i want to apply workword',NULL,0,0),(1437206767489634312,3,1,1,'2021-09-15 20:26:37',NULL,0,'hi','if you want to apply workoder',NULL,0,0),(1437206767489634313,3,1,1,'2021-09-15 22:43:52',NULL,0,'i want to eat checken','you must accept my request',NULL,0,0);
...
CREATE TABLE `role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL COMMENT 'name of the role',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `deleted` int(11) DEFAULT NULL,
  `text` varchar(45) DEFAULT NULL COMMENT 'text shown in frontend',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
...
INSERT INTO `role` VALUES (1,'ADMIN',NULL,NULL,0,'管理员'),(2,'OPERATOR',NULL,NULL,0,'业务员'),(3,'COLLEGE_LEVEL_LEADER',NULL,NULL,0,'学院领导'),(4,'DEPT_LEVEL_LEADER',NULL,NULL,0,'二级部门领导'),(5,'TEACHER',NULL,NULL,0,'教师'),(6,'UNDERGRADUATE',NULL,NULL,0,'本科生'),(7,'POSTGRADUATE',NULL,NULL,0,'研究生');
...
INSERT INTO `role_permission` VALUES (1,6,12,NULL,NULL,0),(2,6,15,NULL,NULL,0),(3,6,28,NULL,NULL,0),(4,6,30,NULL,NULL,0),(5,6,31,NULL,NULL,0),(6,6,32,NULL,NULL,0),(7,3,33,NULL,NULL,0),(8,6,34,NULL,NULL,0),(9,6,35,NULL,NULL,0),(10,6,26,NULL,NULL,0),(11,6,27,NULL,NULL,0),(12,3,30,NULL,NULL,0),(13,3,31,NULL,NULL,0),(14,5,31,NULL,NULL,0);
...
CREATE TABLE `secondary_dept` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='二级部门表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `secondary_dept` VALUES (1,'计算机系','1'),(2,'实验中心','1');
...
CREATE TABLE `user` (
  ...
  `open_id` varchar(45) DEFAULT NULL COMMENT '微信小程序唯一用户标识',
  ...
  `clazz_name` varchar(50) DEFAULT NULL COMMENT '班级名称，学生专有',
...
INSERT INTO `user` VALUES (1,'ofVnE4tSuvWvRiI2OnSra1kdh-5E','3zwZbNdXM44bvKiv62jB7w==','文超',2,1,NULL,'软工1901',1,NULL,NULL,NULL,'2019012617',1,NULL,0,'2021-08-16 22:11:33','2021-09-25 13:10:27',0,NULL),(2,'lajsljf;las;d;kfjk5E','3zwZbvKiv62jw==','审批者1',1,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,1,'122232334',0,'2021-08-16 22:11:33','2021-09-25 12:51:24',0,NULL),(3,'al;sdjfiwnfnoas','auoienfasdhf9apowe','审批者2',1,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,1,'23308724298',0,'2021-08-16 22:11:33','2021-09-25 13:10:58',0,NULL),(4,'ajsponfalsd;alsdf','alsdjfownfiaskjghad','李某',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2018092873',1,NULL,0,'2021-08-16 22:11:33','2021-09-23 22:01:43',0,NULL),(5,'joawnf;lksd','ouhfklajjskd','张三',1,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,1,'2019010433',0,'2021-08-16 22:11:33','2021-09-23 14:30:50',0,NULL),(6,'hjawofhasjdf','hjawofhasjdf','二狗蛋子',1,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,1,'9237495027',0,'2021-08-16 22:11:33','2021-09-23 22:01:06',0,NULL),(7,'a,shdfw;nfai','fhluwusbfalfui','李四',1,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,1,'9237495027',0,NULL,'2021-09-10 09:49:42',0,NULL),(8,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test1',1,1,NULL,'软工1902',4,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-09-23 21:49:49',0,NULL),(9,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test2',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL),(10,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test3',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL),(11,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test4',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL),(12,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test5',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL),(13,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test6',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL),(14,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test7',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL),(15,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test8',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL),(16,'a;sjdfla;sdjfl;asj','ja;lsdjf;lasdjf','test9',1,1,NULL,'软工1902',1,NULL,NULL,NULL,'2342342342',1,NULL,0,'2021-08-16 22:11:33','2021-08-16 22:11:33',0,NULL);
...
INSERT INTO `user_role` VALUES (1,1,6,NULL,NULL,0),(2,5,3,'2021-09-06 20:46:40',NULL,0),(3,2,3,'2021-09-06 20:46:40',NULL,0),(4,3,3,'2021-09-06 20:46:40',NULL,0),(6,7,3,'2021-09-10 09:50:12',NULL,0),(7,6,3,'2021-09-10 14:59:23',NULL,0),(9,8,6,'2021-09-06 20:46:40',NULL,0),(10,9,6,'2021-09-06 20:46:40',NULL,0),(11,10,6,'2021-09-06 20:46:40',NULL,0),(12,11,6,'2021-09-06 20:46:40',NULL,0),(13,12,6,'2021-09-06 20:46:40',NULL,0),(15,14,6,'2021-09-06 20:46:40',NULL,0),(16,15,6,'2021-09-06 20:46:40',NULL,0),(24,13,6,'2021-09-06 20:46:40',NULL,0),(27,16,6,'2021-09-06 20:46:40',NULL,0),(28,4,6,'2021-09-06 20:46:40',NULL,0),(29,5,5,'2021-09-06 20:46:40',NULL,0);
...
INSERT INTO `work_order_status` VALUES (0,0,'在审'),(1,1,'顺利通过'),(2,2,'不通过'),(3,3,'被撤回');
...
-- Dump completed on 2021-09-28 22:24:24
